    ...
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            else
            {
                ...
                //use designer port..
                using (WebApp.Start<DevNote.API.Startup>(url: baseAddress))
                {
                    // Create HttpCient and make a request to api/values 
                    System.Net.Http.HttpClient client = new System.Net.Http.HttpClient();
                    //Console.WriteLine(baseAddress + "bot/botvalues");
                    //var response = client.GetAsync(baseAddress + "bot/botvalues").Result;

                    var url = baseAddress + "bot/tasktvars/hi";
                  ...
                  // Application.SetCompatibleTextRenderingDefault(false);
                    ...
                    //IDevNoteBrowser chrome = new BrowserForm(); 
                    //devBOT = new frmBaiCrawler(chrome);
...
";
        ...
        public static UI.Forms.frmScriptBuilder MyBuilder { get; set; }
